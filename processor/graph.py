...
class Graph():
    ...
    def get_edge(self, layout):
        ...
        if layout == 'openpose':
            ...
            self.num_node = 13
            self_link = [(i,i) for i in range(self.num_node)]
            neighbor_1base = [(0,1), (0,2), (1,2), (1,3), (3,5), (2,4), (4,6), (1,7),
                        (2,8), (7,9), (9,11), (8,10), (10,12), (7,8)]
            # neighbor_link = [(i - 1, j - 1) for (i, j) in neighbor_1base]
            ...
            self.num_node = 17
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(0, 1), (0, 2), (0, 5), (0, 8), (1, 3), (2, 4), (5, 6),
                            (6, 7), (8, 9), (9, 10), (5, 11), (8, 12), (11, 13), (13, 15),
                            (12, 14), (14, 16)]
            self.edge = self_link + neighbor_link
            self.center = 0
        elif layout == 'police':
            self.num_node = 13
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(0, 1), (0, 12), (1, 2), (3, 12), (3, 4), (4, 5), (0, 6), 
